...
"gsm "<>ToString[fixedform[6,gsmread]]};
Export[$inputfile,input,"text"];
Run["math -run -noprompt < simpannrate.m"];
annin=Import["ann","Table"]//ToExpression;
annrate=annin\[LeftDoubleBracket]1,1\[RightDoubleBracket](*DM annihilation rate per second*);
