...
C     
C     Process: ~xd ~xd~ > dvb dvb WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   ), ZERO)
        FK_MDL_WDVB = SIGN(MAX(ABS(MDL_WDVB), ABS(MDL_MDVB
     $   *SMALL_WIDTH_TREATMENT)), MDL_WDVB)
      ENDIF


      CALL IXXXXX(P(0,1),MDL_MXD,NHEL(1),+1*IC(1),W(1,1))
      CALL OXXXXX(P(0,2),MDL_MXD,NHEL(2),-1*IC(2),W(1,2))
      CALL VXXXXX(P(0,3),MDL_MDVB,NHEL(3),+1*IC(3),W(1,3))
      CALL VXXXXX(P(0,4),MDL_MDVB,NHEL(4),+1*IC(4),W(1,4))
      CALL FFV1_2(W(1,1),W(1,3),GC_13,MDL_MXD, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,2),W(1,4),GC_13,AMP(1))
      CALL FFV1_2(W(1,1),W(1,4),GC_13,MDL_MXD, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,2),W(1,3),GC_13,AMP(2))
