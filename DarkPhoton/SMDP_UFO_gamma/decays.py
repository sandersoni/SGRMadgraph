...
Decay_DVB = Decay(name = 'Decay_DVB',
                  particle = P.DVB,
                  partial_widths = {(P.a,P.a):'(ee**2*gSM**2*MDVB**6)/(64.*cmath.pi*abs(MDVB)**3)',
                                    (P.e__minus__,P.e__plus__):'(((ee**2*gSM**2*MDVB**2)/5.e19 - (ee**2*gSM**2*Me**2)/1.25e19)*cmath.sqrt(MDVB**4 - 4*MDVB**2*Me**2))/(16.*cmath.pi*abs(MDVB)**3)',
                                    (P.P__tilde__Xd,P.P__tilde__Xd__tilde__):'((2*gDM**2*MDVB**2 - 8*gDM**2*MXd**2)*cmath.sqrt(MDVB**4 - 4*MDVB**2*MXd**2))/(16.*cmath.pi*abs(MDVB)**3)'})
