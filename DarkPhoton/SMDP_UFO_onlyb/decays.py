...
Decay_DVB = Decay(name = 'Decay_DVB',
                  particle = P.DVB,
                  partial_widths = {(P.b,P.b__tilde__):'((24*ee**2*gSM**2*MB**2 + 12*ee**2*gSM**2*MDVB**2)*cmath.sqrt(-4*MB**2*MDVB**2 + MDVB**4))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.e__minus__,P.e__plus__):'(((ee**2*gSM**2*MDVB**2)/2.5e19 + (ee**2*gSM**2*Me**2)/1.25e19)*cmath.sqrt(MDVB**4 - 4*MDVB**2*Me**2))/(48.*cmath.pi*abs(MDVB)**3)',
