...
Decay_DVB = Decay(name = 'Decay_DVB',
                  particle = P.DVB,
                  partial_widths = {(P.e__minus__,P.e__plus__):'(((ee**2*gSM**2*MDVB**2)/2.5e19 + (ee**2*gSM**2*Me**2)/1.25e19)*cmath.sqrt(MDVB**4 - 4*MDVB**2*Me**2))/(48.*cmath.pi*abs(MDVB)**3)',
