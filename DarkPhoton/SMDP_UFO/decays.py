...
Decay_DVB = Decay(name = 'Decay_DVB',
                  particle = P.DVB,
                  partial_widths = {(P.b,P.b__tilde__):'(((8*ee**2*gSM**2*MB**2)/3. + (4*ee**2*gSM**2*MDVB**2)/3.)*cmath.sqrt(-4*MB**2*MDVB**2 + MDVB**4))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.c,P.c__tilde__):'(((32*ee**2*gSM**2*MC**2)/3. + (16*ee**2*gSM**2*MDVB**2)/3.)*cmath.sqrt(-4*MC**2*MDVB**2 + MDVB**4))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.d,P.d__tilde__):'(((8*ee**2*gSM**2*MD**2)/3. + (4*ee**2*gSM**2*MDVB**2)/3.)*cmath.sqrt(-4*MD**2*MDVB**2 + MDVB**4))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.e__minus__,P.e__plus__):'((4*ee**2*gSM**2*MDVB**2 + 8*ee**2*gSM**2*Me**2)*cmath.sqrt(MDVB**4 - 4*MDVB**2*Me**2))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.mu__minus__,P.mu__plus__):'((4*ee**2*gSM**2*MDVB**2 + 8*ee**2*gSM**2*MMU**2)*cmath.sqrt(MDVB**4 - 4*MDVB**2*MMU**2))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.s,P.s__tilde__):'(((4*ee**2*gSM**2*MDVB**2)/3. + (8*ee**2*gSM**2*MS**2)/3.)*cmath.sqrt(MDVB**4 - 4*MDVB**2*MS**2))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.t,P.t__tilde__):'(((16*ee**2*gSM**2*MDVB**2)/3. + (32*ee**2*gSM**2*MT**2)/3.)*cmath.sqrt(MDVB**4 - 4*MDVB**2*MT**2))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.ta__minus__,P.ta__plus__):'((4*ee**2*gSM**2*MDVB**2 + 8*ee**2*gSM**2*MTA**2)*cmath.sqrt(MDVB**4 - 4*MDVB**2*MTA**2))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.u,P.u__tilde__):'(((16*ee**2*gSM**2*MDVB**2)/3. + (32*ee**2*gSM**2*MU**2)/3.)*cmath.sqrt(MDVB**4 - 4*MDVB**2*MU**2))/(48.*cmath.pi*abs(MDVB)**3)',
                                    (P.P__tilde__Xd,P.P__tilde__Xd__tilde__):'((4*gDM**2*MDVB**2 + 8*gDM**2*MXd**2)*cmath.sqrt(MDVB**4 - 4*MDVB**2*MXd**2))/(48.*cmath.pi*abs(MDVB)**3)'})
