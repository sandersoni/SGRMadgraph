...
V_38 = Vertex(name = 'V_38',
              particles = [ P.P__tilde__Xd__tilde__, P.P__tilde__Xd, P.a ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_17})

V_39 = Vertex(name = 'V_39',
              particles = [ P.P__tilde__Xd__tilde__, P.P__tilde__Xd, P.DVB ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_13})

V_40 = Vertex(name = 'V_40',
              particles = [ P.b__tilde__, P.b, P.DVB ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_14})

V_41 = Vertex(name = 'V_41',
              particles = [ P.c__tilde__, P.c, P.DVB ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_15})

V_42 = Vertex(name = 'V_42',
              particles = [ P.d__tilde__, P.d, P.DVB ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_14})

V_43 = Vertex(name = 'V_43',
              particles = [ P.e__plus__, P.e__minus__, P.DVB ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_16})

V_44 = Vertex(name = 'V_44',
              particles = [ P.mu__plus__, P.mu__minus__, P.DVB ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_16})

V_45 = Vertex(name = 'V_45',
              particles = [ P.s__tilde__, P.s, P.DVB ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_14})

V_46 = Vertex(name = 'V_46',
              particles = [ P.ta__plus__, P.ta__minus__, P.DVB ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_16})

V_47 = Vertex(name = 'V_47',
              particles = [ P.t__tilde__, P.t, P.DVB ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_15})

V_48 = Vertex(name = 'V_48',
              particles = [ P.u__tilde__, P.u, P.DVB ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV1 ],
              couplings = {(0,0):C.GC_15})
